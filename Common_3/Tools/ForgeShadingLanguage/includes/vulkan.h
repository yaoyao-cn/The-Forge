...
/************************************************************************/
    ...
    //
    //   // 2. Declare buffer address type (creates SceneData_Addr)
    ...
    //
    #define DECLARE_BUFFER_ADDRESS(TYPE) layout(buffer_reference, scalar) readonly buffer TYPE##_Addr { TYPE v[]; }
